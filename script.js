...
document.addEventListener('DOMContentLoaded', () => {
  ...
  --------------------------------------------------- */
  // نکته درباره تصاویر:
  // چون بازتولید اسکرین‌شات‌های رسمی/کپی‌رایت‌دار Rockstar Games مجاز نیست، اینجا از عکس‌های واقعی
  // و آزاد (مجوز Unsplash License — استفاده تجاری و هات‌لینک بدون نیاز به اجازه) استفاده شده که از نظر
  // موضوعی با هر خبر همخوانی دارند (اسکای‌لاین سبک ویس‌سیتی، خودروی نئونی شب، غروب نخل، بارش شبانه و...).
  // برای جایگزینی با عکس‌های واقعی خودتان (اسکرین‌شات، آرت‌ورک و غیره)، فقط کافیست فیلد image هر
  // آیتم را با URL دلخواه‌تان (هر آدرس مستقیمی، از جمله فایل‌های داخل همین ریپازیتوری) عوض کنید.
  const newsData = [
    {
      id: 1,
      category: 'gta6',
      ...
      date: '۲۲ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1732084063011-2680de0415cc?w=900&h=550&fit=crop&q=80'
    },
    {
      id: 2,
      category: 'gta6',
      ...
      date: '۱۸ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1607304823233-34673a96fddd?w=900&h=550&fit=crop&q=80'
    },
    {
      id: 3,
      category: 'online',
      ...
      date: '۲۴ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1552749412-02bd58bcff5f?w=900&h=550&fit=crop&q=80'
    },
    {
      id: 4,
      category: 'community',
      ...
      date: '۲۰ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1607304823233-34673a96fddd?w=900&h=550&fit=crop&q=80&sat=-20'
    },
    {
      id: 5,
      category: 'gta6',
      ...
      date: '۱۵ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1763267270045-b13e2a43800b?w=900&h=550&fit=crop&q=80'
    },
    {
      id: 6,
      category: 'online',
      ...
      date: '۱۲ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1692821565954-8d48cf32d816?w=900&h=550&fit=crop&q=80'
    },
    {
      id: 7,
      category: 'community',
      ...
      date: '۸ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1739372679232-41a7cac24b48?w=900&h=550&fit=crop&q=80&sat=-15'
    },
    {
      id: 8,
      category: 'gta6',
      ...
      date: '۴ تیر ۱۴۰۵',
      image: 'https://images.unsplash.com/photo-1739372679232-41a7cac24b48?w=900&h=550&fit=crop&q=80'
    }
  ];
